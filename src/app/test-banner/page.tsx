...
// vague ("manual entry").
// Each reason is split into a bold title (what went wrong) and a
// description on the line below (what to do). Two-line layout makes
// the action stand apart from the diagnosis so the user can scan the
// banner without reading the full sentence.
function reasonCopy(reason: FileIssueReason, fileLabel: string): { title: string; description: string } {
  switch (reason) {
    case "no_file":
      return {
