...
## 🔑 פער סקרנות — הכלל הכי חשוב
**הוק שומר את התשובה סגורה.** הוא מבטיח ערך, לא מוסר אותו. אם אחרי קריאת ההוק הקורא כבר יודע את התובנה — אין סיבה לצפות בסרטון.
...
**מבחן**: האם אחרי קריאה, הקורא רוצה לצפות כדי לגלות? אם לא — שכתב/י.
